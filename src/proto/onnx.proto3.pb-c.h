...
typedef struct _Onnx__TypeProto__Optional Onnx__TypeProto__Optional;
typedef struct _Onnx__TypeProto__SparseTensor Onnx__TypeProto__SparseTensor;
typedef struct _Onnx__OperatorSetIdProto Onnx__OperatorSetIdProto;
typedef struct _Onnx__FunctionProto Onnx__FunctionProto;
 ...
 */
struct  _Onnx__TypeProto__Optional
{
  ProtobufCMessage base;
  /*
...
struct  _Onnx__TypeProto__SparseTensor
{
  ProtobufCMessage base;
  /*
   * This field MUST NOT have the value of UNDEFINED
